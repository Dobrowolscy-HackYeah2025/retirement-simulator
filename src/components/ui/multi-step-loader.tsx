    ...
    <AnimatePresence mode="wait">
      {loading && (
        ...
        >
          ...
          <div className="bg-gradient-to-t inset-x-0 z-80 bottom-0 bg-white dark:bg-black h-full absolute [mask-image:radial-gradient(900px_at_center,transparent_30%,white)]" />
        </motion.div>
      )}
    </AnimatePresence>
  );
