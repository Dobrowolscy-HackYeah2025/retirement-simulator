...
export const OnboardingPageWrapper = ({
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div className="m-0 mt-12 md:mt-16 rounded-lg md:shadow-md md:border-b md:border-l md:border-r border-foreground/15 h-full bg-white w-2xl max-w-[100%] z-50">
